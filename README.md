...
本项目基于`AGPL-3.0`开源，任何分发、转载、修改行为请务必遵守[该开源协议](https://www.chinasona.org/gnu/agpl-3.0-cn.html)。本项目的Release页面为项目唯一发布源，不存在任何官方群组、不存在社交平台账号同时发布的情形，不存在任何购买、捐赠、打赏等付费入口，谨防上当受骗。
